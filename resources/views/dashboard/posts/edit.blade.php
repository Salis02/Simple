        ...
        <form method="post" action="/dashboard/posts/{{ $post->slug }}">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control @error('title') is-invalid @enderror" id="title"
                    aria-describedby="emailHelp" name="title" value="{{ old('title', $post->title) }}" required autofocus>
                @error('title')
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control @error('slug') is-invalid @enderror" id="slug"
                    aria-describedby="emailHelp" name="slug" value="{{ old('slug', $post->slug) }}" oninput="removeSpaces(this)" required>
                @error('slug')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
